...
export async function generateExport(roomCode: string): Promise<Buffer> {
  ...
  const headers = [
    ...
    "Total Players", "Scenario 1 Choice", "Scenario 2 Choice", "Scenario 3 Choice",
    "Mayor Veto Used (S1)", "Mayor Veto Reason (S1)",
    "Mayor Veto Used (S2)", "Mayor Veto Reason (S2)",
    "Mayor Veto Used (S3)", "Mayor Veto Reason (S3)",
